package app.utilities.reflection;
...
public final class ReflectionApi {
    ...
    public void invokeMethodWithParameters(@NotNull Object instance, @NotNull String methodName, @Nullable Object... methodParameters) throws ReflectionApiException {
        ...
        try {
            ...
            //  Handle exception.
            logIfShould("Failed to invoke model's method <{}>.<{}>({}) using app.utilities.reflection API. Method not found.", clazz, methodName, methodParameters, ex);
            throwIfShould(ex);
        }
    }

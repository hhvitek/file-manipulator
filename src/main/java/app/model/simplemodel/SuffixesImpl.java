...
public class SuffixesImpl implements ISuffixes {

    private static final Logger logger = LoggerFactory.getLogger(SuffixesImpl.class);
    ...
    public SuffixesImpl(@NotNull String categoryName) {
        suffixes = new ArrayList<>();
        name = categoryName;
    }
    ...
    public boolean equals(Object obj) {
        ...
        SuffixesImpl that = (SuffixesImpl) obj;
